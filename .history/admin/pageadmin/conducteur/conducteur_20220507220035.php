...
<div class="main-panel">
        ...
        <div id="add" class="tabcontent">
            <div class="screen-1" id="body">
                ...
                if(isset($_POST["ADD_driver"])){
                    $inser="insert into conducteur(id, nom , Age, line , bus , salaire) VALUES ('$_POST[id]','$_POST[name]','$_POST[Age]','$_POST[line]' , '$_POST[numbus]' , '$_POST[salary]')";
        ...
        $affiche="select *  from conducteur";
		 ...
		 while($row=mysqli_fetch_array($res))
		 {
                 ...
                 echo"<td>"; echo $row["salaire"]; echo"</td>";
